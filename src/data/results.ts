...
export const RESULTS: Record<string, Result> = {
  sim: {
    ...
    quote:
      'The matrix is a system, Neo. That system is our enemy. But when you are inside and look around, what do you see?',
    quoteAuthor: '— Morpheus, The Matrix (1999)',
    stats: [
  ...
  parallel: {
    ...
    quoteAuthor: '— Salman Rushdie, The Ground Beneath Her Feet',
    stats: [
  ...
  brain: {
    ...
    quote:
      'How do I know that I am not dreaming right now? There is no proof. The difference between dream and reality may be thinner than we think.',
    quoteAuthor: '— René Descartes, Meditations on First Philosophy (1641)',
    stats: [
  ...
  loop: {
    ...
    quote:
      "What if I told you that every day you have lived has already been lived? That tomorrow is just yesterday with different clothes on?",
    quoteAuthor: '— 영화 《Groundhog Day》에서 영감받은 가상의 대화',
    stats: [
  ...
  free: {
    ...
    quoteAuthor: '— Jean-Paul Sartre, Existentialism is a Humanism (1945)',
    stats: [
  ...
  observer: {
    ...
    quoteAuthor: '— Bertrand Russell, The Analysis of Matter (1927)',
    stats: [
  ...
  bug: {
    ...
    quote:
      'In any sufficiently complex system, there are true statements that cannot be proven within that system.',
    quoteAuthor: '— Kurt Gödel, Incompleteness Theorems (1931)',
    stats: [
